...
const int frontIRPin = 10;  // Front IR sensor
const int rightIRPin = 12;  // Right IR sensor
const int leftIRPin = 3;   // Left IR sensor
...
void setup() {
  ...
  Wire.begin(21, 22);  // SDA and SCL on the specified pins
  gyro.initialize();
  ...
  attachInterrupt(digitalPinToInterrupt(leftHCSensorPin), countLeftPulses, RISING);a
